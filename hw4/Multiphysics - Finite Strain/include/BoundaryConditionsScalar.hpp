...
class BoundaryConditionsScalar{
    public:
        BoundaryConditionsScalar(const Mesh<Nsd,Nne>& mesh); //default constructor for BoundaryConditionsScalar class
...
#include "BoundaryConditionsScalar.tpp" //include the implementation of the template class in a separate .tpp file